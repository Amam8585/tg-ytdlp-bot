...
class Messages(object):
    ...
    #######################################################
    CREDITS_MSG = (
        "<blockquote>🌟 Особая благодарность спонсору "
        "<a href=\"https://t.me/shazminQ\">mmd</a>\n"
        "🇮🇹 @downloader_Lumebot\n"
        "</blockquote>"
    )
    TO_USE_MSG = (
        "<i>Чтобы пользоваться этим ботом, подпишитесь на "
        "<a href=\"https://t.me/LumeTeam\">@LumeTeam</a></i>\n"
        "После вступления в канал <b>отправьте ссылку на видео снова — "
        "бот скачает его для вас</b> ❤️"
    )

    MSG1 = "Привет "
    MSG2 = "Это второе сообщение. То есть собственное сообщение бота... 😁"
    ERROR1 = "Ссылка не найдена. Пожалуйста, введите URL с <b>https://</b> или <b>http://</b>"
    INDEX_ERROR = "Вы указали неверную информацию. Попробуйте снова..."
...
и так далее...
см. <a href=\"https://t.me/LumeTeam\">список поддерживаемых сайтов</a>
</blockquote>
...
👨💻 <i>Канал:</i> <a href="https://t.me/LumeTeam">@LumeTeam</a>
</blockquote>
    """
...
• Настройка: Свяжитесь с @edite909
...
Свяжитесь со мной, если хотите, чтобы я разрешил вашей группе использовать моих ботов @edite909
————————————
...
• <code>/nsfw off</code> - включить размытие
    ...
    # Error messages
    ERROR_CHECK_SUPPORTED_SITES_MSG = "Проверьте <a href='https://t.me/LumeTeam'>здесь</a>, поддерживается ли ваш сайт"
