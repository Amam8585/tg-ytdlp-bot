...
class Messages(object):
    ...
    #######################################################
    CREDITS_MSG = (
        "<blockquote>🌟 Особая благодарность нашему спонсору "
        "<a href=\"https://t.me/shazminQ\">mmd</a>\n"
        "🇮🇹 при поддержке @downloader_Lumebot\n"
        "</blockquote>\n<b>🌍 Сменить язык: /lang</b>"
    )
    TO_USE_MSG = (
        "<i>Чтобы пользоваться ботом, подпишитесь на канал "
        "<a href=\"https://t.me/LumeTeam\">@LumeTeam</a></i>\n"
        "После вступления <b>отправьте ссылку на видео ещё раз, и бот скачает его для вас</b> ❤️"
    )
