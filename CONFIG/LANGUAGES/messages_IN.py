...
class Messages(object):
    ...
    #######################################################
    CREDITS_MSG = (
        "<blockquote>🌟 विशेष धन्यवाद हमारे प्रायोजक "
        "<a href=\"https://t.me/shazminQ\">mmd</a>\n"
        "🇮🇹 @downloader_Lumebot द्वारा समर्थित\n"
        "</blockquote>\n<b>🌍 भाषा बदलें: /lang</b>"
    )
    TO_USE_MSG = (
        "<i>इस बॉट का उपयोग करने के लिए आपको "
        "<a href=\"https://t.me/LumeTeam\">@LumeTeam</a> चैनल को सब्सक्राइब करना होगा</i>\n"
        "चैनल से जुड़ने के बाद, <b>वीडियो लिंक फिर से भेजें और बॉट इसे आपके लिए डाउनलोड कर देगा</b> ❤️"
    )
