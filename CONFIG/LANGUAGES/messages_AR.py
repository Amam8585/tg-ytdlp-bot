...
class Messages(object):
    ...
    #######################################################
    CREDITS_MSG = (
        "<blockquote>🌟 شكر خاص لراعي البوت "
        "<a href=\"https://t.me/shazminQ\">mmd</a>\n"
        "🇮🇹 بدعم من @downloader_Lumebot\n"
        "</blockquote>\n<b>🌍 غيّر اللغة: /lang</b>"
    )
    TO_USE_MSG = (
        "<i>لاستخدام هذا البوت عليك الاشتراك في قناة "
        "<a href=\"https://t.me/LumeTeam\">@LumeTeam</a></i>\n"
        "بعد انضمامك إلى القناة، <b>أعد إرسال رابط الفيديو وسيحمّله لك البوت</b> ❤️"
    )
