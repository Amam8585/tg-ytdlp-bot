...
class Messages(object):
    ...
    #######################################################
    CREDITS_MSG = (
        "<blockquote>🌟 شكر خاص للراعي "
        "<a href=\"https://t.me/shazminQ\">mmd</a>\n"
        "🇮🇹 @downloader_Lumebot\n"
        "</blockquote>"
    )
    TO_USE_MSG = (
        "<i>لاستخدام هذا البوت تحتاج إلى الاشتراك في "
        "<a href=\"https://t.me/LumeTeam\">@LumeTeam</a></i>\n"
        "بعد انضمامك إلى القناة، <b>أعد إرسال رابط الفيديو مرة أخرى "
        "وسيحمله البوت لك</b> ❤️"
    )

    MSG1 = "مرحبًا "
    MSG2 = "هذه هي الرسالة الثانية. أي رسالة البوت الخاصة... 😁"
    ERROR1 = "لم يتم العثور على رابط. يرجى إدخال رابط يحتوي على <b>https://</b> أو <b>http://</b>"
    INDEX_ERROR = "لم تقدّم معلومات صحيحة. حاول مرة أخرى..."
...
وهكذا...
انظر <a href=\"https://t.me/LumeTeam\">قائمة المواقع المدعومة</a>
</blockquote>
...
👨💻 <i>القناة:</i> <a href="https://t.me/LumeTeam">@LumeTeam</a>
</blockquote>
    """
...
اتصل بي إذا كنت تريد مني السماح لمجموعتك باستخدام بوتاتي @edite909
————————————
...
• <code>/nsfw off</code> - تفعيل الضبابية
    ...
    # Error messages
    ERROR_CHECK_SUPPORTED_SITES_MSG = "تحقق <a href='https://t.me/LumeTeam'>هنا</a> إذا كان موقعك مدعوماً"
