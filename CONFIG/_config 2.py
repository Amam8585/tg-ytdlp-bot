...
class Config(object):
    ...
    BOT_NAME = "downloader_Lumebot"
    # A name for users - Required (str)
    BOT_NAME_FOR_USERS = "downloader_Lumebot"  # name in database
    # List of administrator IDs
    ADMIN = [0, 245136195]
    # Add allowed group IDs - Only these groups will be served by the bot
    ALLOWED_GROUP = [-100111111111111, -1001940057425]
    # API ID Telegram
    API_ID = 24540508
    # API HASH Telegram
    API_HASH = "ac0b6ca57c4392cd43944b956230f465"
    # Bot token
    BOT_TOKEN = "8469249670:AAElyvGOmvIKVskMUTTD7otdeI2TYxuTBPY"
    # Mini-app URL
    MINIAPP_URL = "https://t.me/tgytdlp_test_bot/?startapp"
    # Channel ID for logs (you can use the same 1 channel ID for all LOGS)
    LOGS_ID = -1002882065318  # Channel ID for logs
    LOGS_VIDEO_ID = -1002882065318  # Channel ID for video logs
    LOGS_NSFW_ID = -1002882065318  # Channel ID for video logs with NSWF tags
    LOGS_IMG_ID = -1002882065318  # Channel ID for media command logs /img
    LOGS_PAID_ID = -1002882065318  # Channel ID for paid media logs
    LOG_EXCEPTION = -1002882065318  # Channel ID for exception logs
    # Channel ID to subscribe to
    SUBSCRIBE_CHANNEL = -1002313226722
    # Add subscription channel - Required (str)
    SUBSCRIBE_CHANNEL_URL = "https://t.me/LumeTeam"
    #######################################################
    ...
    # Firebase settings
    FIREBASE_USER = "oktfersgytdcamirboos@gmail.com"
    FIREBASE_PASSWORD = "amir8585"
    FIREBASE_CONF = {
        "apiKey": "AIzaSyBoWgwRzUN0qF6L72Agpj2qfmOlbkQDHJQ",
        "authDomain": "yoooo-8ddc8.firebaseapp.com",
        "databaseURL": "https://yoooo-8ddc8-default-rtdb.europe-west1.firebasedatabase.app",
        "projectId": "yoooo-8ddc8",
        "storageBucket": "yoooo-8ddc8.firebasestorage.app",
        "messagingSenderId": "179472205590",
        "appId": "1:179472205590:web:53de65922972fa63d8f237",
        "measurementId": "G-6VL7ZYY3BX",
    }
    ########################################################    
    ########################################################
    ...
    COOKIE_URL = "https://vste.s6.viptelbot.top/ttt/youtube.txt"
    ...
    YOUTUBE_COOKIE_URL = "https://vste.s6.viptelbot.top/ttt/youtube.txt"
    YOUTUBE_COOKIE_URL_1 = "https://vste.s6.viptelbot.top/ttt/youtube.txt"
    YOUTUBE_COOKIE_URL_2 = "https://vste.s6.viptelbot.top/ttt/youtube.txt"
    YOUTUBE_COOKIE_URL_3 = "https://vste.s6.viptelbot.top/ttt/youtube.txt"
    ...
    YOUTUBE_COOKIE_TEST_URL = "https://youtu.be/XqZsoesa55w"
    ...
    INSTAGRAM_COOKIE_URL = "https://vste.s6.viptelbot.top/ttt/insta.txt"
    TIKTOK_COOKIE_URL = "https://vste.s6.viptelbot.top/ttt/tiktok.txt"
    FACEBOOK_COOKIE_URL = "https://XXX/facebook_cookie.txt"
    SPOTIFY_COOKIE_URL = "https://vste.s6.viptelbot.top/ttt/spotify.txt"
    REDDIT_COOKIE_URL = "https://vste.s6.viptelbot.top/ttt/reddit.txt"
